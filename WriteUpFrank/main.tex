...
Computer sind heutzutage allgegenwärtig. Viele Menschen besitzen mobile Geräte, die in Sachen Rechenleistung stationären Computern nur noch in wenig nachstehen.
...
Die Idee des Projekts ist es, eine Handyanwendung zu programmieren, die die nötigen Daten für eine verlässliche Positionsvorhersage sammelt, und diese auszuwerten. Somit soll untersucht werden, ob es prinzipiell möglich wäre (und mit welcher Genauigkeit), Bewegungen von Menschen vorherzusagen.
